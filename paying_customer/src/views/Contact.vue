                            ...
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="https://www.linkedin.com/in/marko-tomljanovi%C4%87-bb48391ab/">
                                                <i class="fa fa-linkedin"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="https://www.instagram.com/tomljanovic.ma/">
                                                <i class="fa fa-instagram"></i>
                                            </a>
                                        </li>
                                    </ul>
