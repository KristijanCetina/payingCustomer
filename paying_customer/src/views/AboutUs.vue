...
<div class="row">
    ...
    <div class="col-xs-6 col-md-4"><h1 style="margin-left: 60px">Lorem Ipsum</h1></div>
  </div>
  <div class="row">
    <div class="col-xs-6 col-md-6">
      <img style="width: 400px; margin-left: 53px; border-radius: 83px" src="@/assets/logoPC.png" alt="Logo">
    ...
    <div class="col-xs-6 col-md-4 col"><br><p style="text-align: justify;">
